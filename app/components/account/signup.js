...
import GradientButton from '../gradientButton/';1
...
class Signup extends Component {
  ...
  render() {
    let renderIcon = () => {
      return <Image style={styles.image} source={require('../../assets/images/logo.png')} style={{width: 100, height: 100}}/>;
    };
    return (
      <View style={{flex: 1,}}>
      <RkAvoidKeyboard
        ...
        <View style={styles.content}>
          <View>
            <RkTextInput rkType='rounded' placeholder='Name' onChangeText={this.changeName.bind(this)}/>
            <RkTextInput rkType='rounded' placeholder='Email' onChangeText={this.changeEmail.bind(this)}/>
