...
export class SocialBar extends RkComponent {
  ...
  render() {
    ...
    let updateLikes = () => {
      ...
      else this.setState({ likes: this.likes });
    };
    ...
    let updateShares = () => {
      ...
      else this.setState({ shares: this.shares });
    };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.section}>
          <RkButton rkType="clear" onPress={updateComments}>
            <RkText rkType="awesome hintColor" style={styles.icon}>
              <Icon name="comment" size={25} color={color} />
            </RkText>
            <RkText
        ...
        <View style={styles.section}>
          <RkButton rkType="clear" onPress={updateShares}>
            <RkText rkType="awesome hintColor" style={styles.icon}>
              <Icon name="share" size={25} color={color} />
            </RkText>
            <RkText
              rkType="primary4 hintColor"
              style={[styles.label, { color: color }]}
